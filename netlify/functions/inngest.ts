...
// Task notification function removed - replaced with live-data approach
// See: useDealTaskIndicators pattern for how notifications are now handled in real-time
