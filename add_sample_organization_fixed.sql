-- Sample script to add a new organization with stakeholders (CORRECTED VERSION)
-- Run this to see the relationship intelligence system in action

-- Step 1: Add a new organization (correct schema)
...
INSERT INTO stakeholder_analysis (
  ...
  (
    ...
    'Visionary leader focused on growth and market positioning',
  ...
  (
    ...
    'Highly technical, innovation-focused, values cutting-edge solutions',
