...
- Name: Deal CRUD Operations >> should allow clearing a deal's specific probability and fallback to stage probability
- Location: /Users/tomaskovarik/059_PIPECD/PIPECD/e2e/deal-crud.spec.ts:162:7
...
Call log:
  ...
  - attempting select option action
    ...
    at /Users/tomaskovarik/059_PIPECD/PIPECD/e2e/deal-crud.spec.ts:164:5
```
...
- dialog "Create New Deal":
  ...
  - group:
    - text: Deal Name
    - textbox "Deal Name": Test Deal Clear Prob 1746975555122
  - group:
    - text: Pipeline
    - combobox "Pipeline":
