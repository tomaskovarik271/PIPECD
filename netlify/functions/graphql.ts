...
const typeDefs = /* GraphQL */ `
  ...
  type Person { 
    ...
    # updated_at: DateTime!
    # user_id: ID! 
    first_name: String # Keep one simple field
    # last_name: String
    # email: String
    # phone: String
    # notes: String
    # organization_id: ID 
    # organization: Organization # REMOVED NESTED
    # deals: [Deal!] # REMOVED NESTED
  }
  # --- END SIMPLIFIED ---
  ...
  type Deal {
    ...
    person: Person # Associated person (updated from contact) <- Still points to simplified Person
  }
  ...
  type Lead {
      ...
      # updated_at: DateTime!
      # user_id: ID!
      name: String # Keep one simple field
      # email: String
      # phone: String
      # company_name: String
      # source: String
