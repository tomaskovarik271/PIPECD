...
- Name: Deal CRUD Operations >> should allow creating a new deal with specific probability
- Location: /Users/tomaskovarik/059_PIPECD/PIPECD/e2e/deal-crud.spec.ts:106:7
...
Call log:
  ...
  - attempting select option action
    ...
    at /Users/tomaskovarik/059_PIPECD/PIPECD/e2e/deal-crud.spec.ts:112:5
```
...
- dialog "Create New Deal":
  ...
  - group:
    - text: Deal Name
    - textbox "Deal Name": Test Deal Create 1746975555120
  - group:
    - text: Pipeline
    - combobox "Pipeline":
